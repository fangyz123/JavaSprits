...
<body style="position:fixed;width:100%;background-size: cover;height:100%;background-image: url('images/login1.jpg')">
	...
	<div style="height:100px;">
		<img alt="" src="images/role.jpg" width="80px";height="80px" style="margin-top:10px;margin-left:120px">
	</div>
	...
	<div class="login-form" style="" >
		...
		<form id="login_test" action="login" method="post" onsubmit=" return checkLogin();" style="opacity: 1;">
			...
			<div style="width:600px;height:2em;text-align: center">
				<span id="checkUserName" style="color: black; font-size: 20px;margin-top:1em;"></span>
			</div>
				<!--onfocus="this.value = '';"  -->
			<div style="width:600px">
			...
			<span id="checkPassword" style="color: black; font-size: 20px;margin-top:1em;"></span><br>
