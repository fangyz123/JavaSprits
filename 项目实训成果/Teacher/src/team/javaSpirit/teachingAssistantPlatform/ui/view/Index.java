...
import team.javaSpirit.teachingAssistantPlatform.ui.event.DistributionWorkMouseListener;
...
import team.javaSpirit.teachingAssistantPlatform.ui.event.QuizContentMouseListener;
...
import team.javaSpirit.teachingAssistantPlatform.ui.event.UploadQuizMouseActionListener;
...
public class Index extends JFrame {
	...
	public void setClasstest() {
		...
		menu7.add(label_9);
		// 课堂小测按钮
		JButton button_11 = new JButton("查看小测");
		...
		menu7.add(button_11);
		QuizContentMouseListener q=new QuizContentMouseListener(this);
		button_11.addMouseListener(q);
		menu7.addMouseListener(q);
	}
	...
	public void setReleasejob() {
		...
		menu8.add(label_1);
		// 发布作业按钮
		JButton button_2 = new JButton("发布小测");
		...
		menu8.add(button_2);
		// 事件对象
		DistributionWorkMouseListener disWork = new DistributionWorkMouseListener(this);
		// 添加事件监听
		menu8.addMouseListener(disWork);
		button_2.addMouseListener(disWork);
	}
	...
	public void centerContent() {
		...
		table_1.setBounds(1, 32, 907, 300);
...
//		scrollPane_1.setViewportView(table_2);
	...
	public void chatView() {
		...
		panel_5.setBounds(1029, 135, 244, 523);
	...
	public void setQuizContent() {
		...
		centerpl.setLayout(null);
		// 内容展示标题
		JLabel title = new JLabel("课堂小测");
		title.setForeground(SystemColor.textHighlight);
		title.setFont(new Font("宋体", Font.BOLD, 20));
		title.setHorizontalAlignment(SwingConstants.CENTER);
		title.setBounds(380, 10, 105, 40);
		centerpl.add(title);		
		...
		for(ClassCourse cc:list) {
			// 滚动条
			JScrollPane scrollPane = new JScrollPane();
			scrollPane.setLocation(45, 50+i*160);
			scrollPane.setSize(840, 120);
			scrollPane.setBorder(null);
			centerpl.add(scrollPane);
 			i++;
			JLabel jl2 = new JLabel("11111111111");
			jl2.setBounds(380, 160*i, 105, 40);
			// 资源列表容器
			JPanel text = new JPanel() {
				public void paintComponent(Graphics g) {
					super.paintComponent(g);
			...
			text.setBackground(null);
			text.setForeground(new Color(173, 216, 230));
			text.setPreferredSize(new Dimension(700, 300));
			scrollPane.setViewportView(text);
			
			
			JLabel lblNewLabel_1 = new JLabel("  "+cc.getClass_name(),JLabel.CENTER);
			lblNewLabel_1.setFont(new Font("黑体", Font.PLAIN, 20));
			lblNewLabel_1.setForeground(SystemColor.textHighlight);
			lblNewLabel_1.setPreferredSize(new Dimension(700, 30));
			text.add(lblNewLabel_1);
			
			Map<String,List<Quiz>> map=qs.getQuizAsChapter(cc);
			...
			for(int j=0;j<list3.size();j++) {
				JLabel jl;
				if((j+1)==list3.size())
					jl=new JLabel("   "+list3.get(j)+"   "+map.get(list3.get(j)).get(0).getOldname()+"   "+(20+j+i)+"人已完成",JLabel.LEFT);
				else
					jl=new JLabel("   "+list3.get(j)+"   "+map.get(list3.get(j)).get(0).getOldname()+"   "+(20+j+i)+"人已完成"+"         "+list3.get(j+1)+"   "+map.get(list3.get(j+1)).get(0).getOldname()+"   "+(18+j)+"人已完成",JLabel.LEFT);
				jl.setFont(new Font("宋体", Font.BOLD, 16));
				jl.setPreferredSize(new Dimension(700, 30));
				jl.setForeground(SystemColor.textHighlight);
//				jl.setHorizontalAlignment(SwingConstants.CENTER);
				text.add(jl);
				j++;
			}
	...
	public void jumpQuizContent() {// 顶部菜单栏
		topMenu();
		// 左侧菜单栏
		leftMenu();
		// 设置背景图
	 ...
	 * 
	 * <p>
	 * Title: distributionWorkContent
	 * </p>
	 * <p>
	 * Description:发布小测内容页
	 * </p>
	 */
	public void distributionWorkContent() {
		centerpl.setLayout(null);

		JLabel label_1 = new JLabel("\u9009\u62E9\u8BFE\u7A0B\u73ED\u7EA7");
		label_1.setBounds(77, 108, 334, 60);
		label_1.setHorizontalAlignment(SwingConstants.CENTER);
		label_1.setFont(new Font("幼圆", Font.BOLD, 25));
		label_1.setForeground(SystemColor.textHighlight);
		centerpl.add(label_1);
		
		
		//combox选择的课程
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setFont(new Font("宋体", Font.PLAIN, 18));
		comboBox_1.setBounds(376, 110, 334, 54);
		comboBox_1.setForeground(SystemColor.textHighlight);
		comboBox_1.setName("");
		comboBox_1.setEnabled(true);
		comboBox_1.setEditable(true);
		centerpl.add(comboBox_1);
		
		
		QuizService qs=new QuizService();
		
		List<String> l = qs.searchclassname(Constant.myTeacher.getTid());
		for(int i = 0 ; i < l.size() ; i++) {
			comboBox_1.addItem(l.get(i));
			}
		...
		textField_1.setBounds(376, 240, 334, 54);
		centerpl.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel label = new JLabel("设置章节名称");
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setFont(new Font("幼圆", Font.BOLD, 25));
		label.setBounds(77, 238, 334, 60);
		...
		// 上传课堂小测
		JLabel uploads = new JLabel("");
		uploads.setIcon(new ImageIcon("image/upload1.jpg"));
		uploads.setBounds(400, 327, 205, 60);
		centerpl.add(uploads);
		uploads.addMouseListener(new UploadQuizMouseActionListener(this,comboBox_1,textField_1));
		
		
//		// 上传文件图片
//		JLabel uploads = new JLabel("");
//		uploads.setIcon(new ImageIcon("image/upload.jpg"));
//		uploads.setBounds(516, 66, 319, 70);
//		centerpl.add(uploads);
//		uploads.addMouseListener(new UploadQuizMouseActionListener(this,comboBox_1,new JTextField("预测")));
	 ...
	 * 
	 * <p>
	 * Title: jumpDistributionWork
	 * </p>
	 * <p>
	 * Description:跳转到发布作业界面
	 * </p>
	 */
	public void jumpDistributionWork() {
		// 顶部菜单栏
		topMenu();
		// 左侧菜单栏
		leftMenu();
