...
import com.ryy.ui.controller.ResourceMouseListener;
import com.ryy.ui.controller.ShareResourceMouseListener;
...
public class Index extends JFrame {
	...
	public void setShareMenu() {
		...
		menu7.addMouseListener(new ShareResourceMouseListener(getIndex()));
		//资源共享菜单图标
		...
		menu7.add(bt7);
		bt7.addMouseListener(new ShareResourceMouseListener(getIndex()));
	...
	public void setRemote() {
		...
		remortbt.setBounds(66, 120, 129, 31);
...
//		bgContentPane.add(centerpl);
	...
	/**
	 * 
	 * <p>Title: setShareResource</p>
	 * <p>Description:设置共享资源页面，向centerpl中添加控件，向contentpl中添加控件 </p>
	 */
	public void setShareResource() {
		...
		//上传文件图片
		contentpl.add(title);JLabel uploads = new JLabel("");
		uploads.setIcon(new ImageIcon(this.getClass().getResource("/img/upload.jpg")));
		uploads.setBounds(659, 10, 124, 36);
		contentpl.add(uploads);
		uploads.addMouseListener(new UploadMouseListener(getIndex()));
		//滚动条
	   ...
	   text.setBackground(null);
		...
		for(ShareResource sr:list) {
			if(sr.getOldfile()==null||sr.getStu()==null||sr.getUploadtime()==null) {
				...
				Students s=new StudentsDaoImpl().getStudentById(sr.getStu().getSid());
				JLabel jl=new JLabel("题目："+sr.getOldfile()+"   上传者："+s.getName()+"    时间："+sr.getUploadtime());
				jl.setFont(new Font("宋体", Font.BOLD, 14));
				jl.setPreferredSize(new Dimension(700, 45));
				jl.setHorizontalAlignment(SwingConstants.CENTER);
				jl.addMouseListener(new ResourceMouseListener(getIndex(),sr));
				text.add(jl);
			}
		}
	}
	...
	/**
	 * 
	 * <p>Title: jumpShareResource</p>
	 * <p>Description: 转到共享资源界面</p>
	 */
