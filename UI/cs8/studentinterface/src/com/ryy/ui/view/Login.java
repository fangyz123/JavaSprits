...
import com.ryy.ui.controller.LoginMouseActionListener;
...
public class Login extends JFrame {
	...
	public void setLogo() {
		...
		logo.setIcon(new ImageIcon(this.getClass().getResource("/img/logo1.png")));
	...
	public void setRememberPassword() {
		...
		rememberPassword.setBackground(null);
	...
	public void setLoginIng() {
		...
		this.bgContentPane = new JPanel() {
            public void paintComponent(Graphics g) {
                super.paintComponent(g);
                ImageIcon ii = new ImageIcon(this.getClass().getResource("/img/bg1.jpg"));
                g.drawImage(ii.getImage(), 0, 0, getWidth(), getHeight(), ii.getImageObserver());
            }
        };
        bgContentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
