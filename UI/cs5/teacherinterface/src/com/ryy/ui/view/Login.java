...
import com.ryy.ui.controller.TeacherLoginActionListener;
import com.ryy.ui.controller.TeacherLoginMouseActionListener;
import com.ryy.ui.teacher.service.TeacherServiceImpl;
import com.ryy.ui.util.DlProPertiesUtil;
/**
 * 
* <p>Title: Login</p>
* <p>Description: 教师端登录界面</p>
* @author renyuyuan
* @date 2018年12月11日
 */
...
public class Login extends JFrame {
	...
	public void setLoginButton() {
		...
		bgContentPane.add(loginButton);
		 // 给登录按钮添加事件
		loginButton.addActionListener(new TeacherLoginActionListener(getLogin()));
//             
	}
	/**
	 * 
	...
	public void setModifyPassword() {
		...
		modifyPassword.addMouseListener(new TeacherLoginMouseActionListener(getLogin()));
