...
import team.javaSpirit.teachingAssistantPlatform.ui.event.TeachBackMouseListener;
import team.javaSpirit.teachingAssistantPlatform.ui.event.UploadMouseListener;
import team.javaSpirit.teachingAssistantPlatform.ui.event.XiaoceMouseListener;
...
public class Index extends JFrame {
	...
	public void setClasstest() {
		...
		menu7.add(button_11);
		// 事件对象
		XiaoceMouseListener disWork = new XiaoceMouseListener(this);
		// 添加事件监听
		menu7.addMouseListener(disWork);
		button_11.addMouseListener(disWork);
	}
	...
	public void setTeachback() {
		...
		menu9.add(button_3);
		// 事件对象
		TeachBackMouseListener tb = new TeachBackMouseListener(this);
		// 添加事件监听
		menu9.addMouseListener(tb);
		button_3.addMouseListener(tb);
	}
	...
	public void teachBackContent() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("E:\\eclipse-jee-oxygen-2-win32-x86_64\\eclipse-workspace\\Teacher\\image\\delete.png"));
		...
		int b=41;
		while (i<=3) {
		JCheckBox chckbxNewCheckBox_1 = new JCheckBox("啦啦啦    ？？？？？");
		...
		panel.add(chckbxNewCheckBox_1);
		 ...
		 CheckBoxMouseListener cb=new CheckBoxMouseListener();
	...
	public void xiaoCeContent() {
		...
		int i=1;
		while (i<=3) {
			JLabel lblNewLabel_1 = new JLabel("大数据");
			lblNewLabel_1.setFont(new Font("宋体", Font.PLAIN, 25));
			lblNewLabel_1.setVerticalAlignment(SwingConstants.TOP);
			lblNewLabel_1.setPreferredSize(new Dimension(400, 232));
			panel.add(lblNewLabel_1);
			
			JScrollPane scrollPane = new JScrollPane((Component) null);
			scrollPane.setBounds(0, 32, 400, 200);
			...
			panel_1.setPreferredSize(new Dimension(378,1000));
	...
	public void distributionWorkContent() {
		...
		JLabel label = new JLabel("\u8F93\u5165\u5C0F\u6D4B\u540D\u79F0");
		...
		uploads.setBounds(551, 327, 205, 60);
		centerpl.add(uploads);
		uploads.addMouseListener(new UploadMouseListener(this));
