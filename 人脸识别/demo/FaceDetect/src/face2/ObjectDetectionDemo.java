...
//                    new Scalar(0, 0, 255));
        	Imgproc.rectangle(frame,new Point(face.x+face.width,face.y + face.height ), new Point(face.x,face.y), new Scalar(0,0,255));
...
//            }
    ...
    public void run(String[] args) {
        String filenameFaceCascade = args.length > 2 ? args[0] : "D:\\opencv\\opencv-3.4.1-vc14_vc15\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml";
        String filenameEyesCascade = args.length > 2 ? args[1] : "D:\\opencv\\opencv-3.4.1-vc14_vc15\\opencv\\sources\\data\\haarcascades\\haarcascade_eye_tree_eyeglasses.xml";
