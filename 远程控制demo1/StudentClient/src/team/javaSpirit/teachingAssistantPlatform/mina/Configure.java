...
public class Configure {
	...
	* <p>Description: 无参构造函数</p>
	...
	/**
	 * <p>Title: connect</p>
	 * <p>Description: 连接函数。设置连接的IP和端口号。
	 * 设置传输的方式是同步；得到一个网络通信的会话。</p>
	 * @param ip 服务器的IP地址
	 * @param port 开启服务的端口号
	 * @throws IOException
	 */
	...
	/**
	 * <p>Title: getConnector</p>
	 * <p>Description: 返回连接的对象</p>
	...
	/**
	 * <p>Title: setConnector</p>
	 * <p>Description: 设置连接的对象</p>
	...
	/**
	 * <p>Title: getConnectFuture</p>
	 * <p>Description: 返回设置传输方式的对象</p>
	...
	/**
	 * <p>Title: setConnectFuture</p>
	 * <p>Description: 设置传输方式的对象</p>
