...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<script type="text/javascript">
		function countDown(){
			...
			if(time.innerHTML == 1){
				window.location.href="../Teacher/addStudent?className="+classname
			}else{
...
<!-- top Products -->
	<div class="ab_content">
		<div class="sucess" style="text-align:center;">
			...
			<div style="margin-top: 50px"><h3>创建班级成功</h3></div>
			<div style="margin-top: 20px"><span id="time">5</span>秒后跳转到学生信息添加页</div>
		</div>
	</div>
